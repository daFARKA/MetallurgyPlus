...
public class ExtractorMenu extends AbstractContainerMenu {
    public static final int[][] INPUT_POSITIONS = {{22, 21}, {40, 21}, {22, 39}, {40, 39}};
    public static final int[][] OUTPUT_POSITIONS = {{98, 21}, {116, 21}, {134, 21}, {98, 39}, {116, 39}, {134, 39}, {98, 57}, {116, 57}, {134, 57}};
    public static final int EXTRACTOR_SLOTS_COUNT = INPUT_POSITIONS.length + OUTPUT_POSITIONS.length;
    ...
    public ExtractorMenu(int pContainerId, Inventory inv, FriendlyByteBuf friendlyByteBuf) {
    ...
    public ExtractorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        checkContainerSize(inv, EXTRACTOR_SLOTS_COUNT);
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = EXTRACTOR_SLOTS_COUNT;  // must be the number of slots you have!
    @Override
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.EXTRACTOR.get());
    }
