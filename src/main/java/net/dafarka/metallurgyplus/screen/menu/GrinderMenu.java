...
import net.dafarka.metallurgyplus.block.entity.GrinderBlockEntity;
...
public class GrinderMenu extends AbstractContainerMenu {
    public static final int[][] INPUT_POSITIONS = {{8, 21}, {26, 21}, {8, 39}, {26, 39}};
    public static final int[][] OUTPUT_POSITIONS = {{80, 21}, {98, 21}, {116, 21}, {134, 21}, {152, 21}, {80, 39}, {98, 39}, {116, 39}, {134, 39}, {152, 39},
        {80, 57}, {98, 57}, {116, 57}, {134, 57}, {152, 57}};
    public static final int GRINDER_SLOTS_COUNT = INPUT_POSITIONS.length + OUTPUT_POSITIONS.length;
    ...
    public GrinderMenu(int pContainerId, Inventory inv, FriendlyByteBuf friendlyByteBuf) {
    ...
    public GrinderMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        checkContainerSize(inv, GRINDER_SLOTS_COUNT);
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = GRINDER_SLOTS_COUNT;  // must be the number of slots you have!
    @Override
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.GRINDER.get());
    }
