...
public class DynamicGemBlockColor implements BlockColor {


    public DynamicGemBlockColor() { }
    ...
    public int getColor(BlockState pState, @Nullable BlockAndTintGetter pLevel, @Nullable BlockPos pPos, int pTintIndex) {
        if (pTintIndex == 0) {
            ...
            return ModBlocks.GEM_COLOR_MAP.get(fullName.split("\\.")[2]) != null ? ModBlocks.GEM_COLOR_MAP.get(fullName.split("\\.")[2]) : -1;
        }
        return -1;
    }
}