...
public class DynamicSolarPanelColor implements BlockColor, ItemColor {

    public DynamicSolarPanelColor() {}
    ...
    public int getColor(BlockState pState, @Nullable BlockAndTintGetter pLevel, @Nullable BlockPos pPos, int pTintIndex) {
        if (pTintIndex == 0) {
            ...
            return ModBlocks.SOLAR_PANEL_COLOR_MAP.get(tier) != null ? ModBlocks.SOLAR_PANEL_COLOR_MAP.get(tier) : -1;
        }
        return -1;
    }
